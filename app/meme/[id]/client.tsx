...
interface MemePageClientProps {
  memeId: string
}

export default function MemePageClient({ memeId }: MemePageClientProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* Related Memes */}
        <div className="mt-8">
          <RelatedMemes currentTop={memeData.top} currentBottom={memeData.bottom} />
        </div>
      </div>
    </div>
  )
